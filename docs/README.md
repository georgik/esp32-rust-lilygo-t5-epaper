# ESP32 Rust LilyGO T5 - experimental

Experimental implementation of driver for LilyGo T5
...
- Terminal approach:
    ```
    $HOME/.espressif/tools/xtensa-esp32-elf/esp-2021r2-patch3-8.4.0/xtensa-esp32-elf/bin/xtensa-esp32-elf-gdb target/xtensa-esp32-espidf/debug/lilygo_t5 -ex "target remote localhost:9333"
    ```
